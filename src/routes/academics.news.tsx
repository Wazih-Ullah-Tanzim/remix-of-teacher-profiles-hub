      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 space-y-4">
            {notices.map((n, i) => (
              <article key={n.slug} className="tilt-card animate-fade-up flex gap-5 rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)]" style={{ animationDelay: `${i * 80}ms` }}>
                ...
                <div className="flex-1">
                  ...
                  <Link to="/academics/news/$slug" params={{ slug: n.slug }} className="story-link mt-4 inline-flex items-center gap-1 text-sm font-bold text-accent">Read More <ArrowRight className="h-4 w-4" /></Link>
                </div>
              </article>
            ))}
          </div>
