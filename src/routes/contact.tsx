        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 md:grid-cols-5 lg:px-8">
          <div className="md:col-span-2">
            ...
            <div className="mt-8 space-y-4">
              {[
                { icon: MapPin, label: "Address", value: "Mymensingh City, Bangladesh" },
                { icon: Phone, label: "Phone", value: "+880 1700 000 000" },
                { icon: Mail, label: "Email", value: "info@johnamosbd.com" },
                { icon: Clock, label: "Hours", value: "Sun – Thu · 8:00 AM – 2:30 PM" },
              ].map((c) => (
                <div key={c.label} className="flex items-start gap-4 rounded-2xl border border-border bg-card p-5 shadow-[var(--shadow-card)]">
                  ...
                  <div>
                    ...
                    <div className="mt-0.5 font-semibold text-primary">{c.value}</div>
                  </div>
                </div>
              ))}
            </div>
